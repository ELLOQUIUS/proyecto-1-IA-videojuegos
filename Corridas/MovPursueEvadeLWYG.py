# Ejecutar archivo con "python -m Corridas.MovPursueEvadeLWYG.py" en caso de no usar
# import sys
# import os
...
radioINT = 50
radioEXT = 270
o10 = Kinematic([200,400],[0,0],0,0) # Personaje1 (LookWhereAreYouGoing) 
o11 = Kinematic([800,400],[0,0],0,0) # Personaje2 (LookWhereAreYouGoing)
t10 = Kinematic([500,400],[0,0],0,0) # Target (LookWhereAreYouGoing)
t10fant = Kinematic([500,400],[0,0],0,0) # Target fantasma (LookWhereAreYouGoing)

k100 = LookWhereYoureGoing(o10,t10,1,5,0.01,0.9,0.1)
k101 = Pursue(o10,t10fant,0.5,8,radioINT-20,radioEXT,0.1,1.5,t10) # Para hacer la combinacion con pursue
k102 = LookWhereYoureGoing(o11,t10,1,5,0.01,0.9,0.1)
k103 = Evade(o11,t10fant,0.5,1.5,t10) # Para hacer la combinacion con evade
...
while corriendo:
    ...
    o10.update(lwayg_pursue,8,1)
    o11.update(lwayg_evade,2,1)

    keys = pygame.key.get_pressed() # Para agarrar las teclas del teclado y mover el objetivo
    movimiento_teclado_cambio_velocity(keys,t10,velocity,True)

    t10.position[0] += t10.velocity[0]
    t10.position[1] += t10.velocity[1]
    ...
    pygame.draw.rect(ventana, (255, 100, 10), (t10.position[0]-20, t10.position[1]-20, 40, 40)) # LookWhereAreYouGoing '''
